...
template<typename T, bool numeric> struct deref_arithmetic
{
};

template<typename T> struct deref_arithmetic<T,true>
{
    typedef T base_type;
    typedef T reference_type;
};

template<typename T> struct deref_arithmetic<T,false>
{
    typedef T base_type;
    typedef T &reference_type;
};
...
{
    typedef typename deref_arithmetic<T,is_arithmetic<T>::is_true >::base_type base_type;
    typedef typename deref_arithmetic<T,is_arithmetic<T>::is_true >::reference_type reference_type;
};
